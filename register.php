...
<head>
    ...
    <title>e-Program - Register</title>
                    ...
                    <div class="col-lg-7">
                        <div class="p-5">
                            ...
                            <form action="" method="post" onsubmit="return validasi_input2(this)" autocomplete="off"
                                ...
                                <input type="hidden" name="id" value="guru">

                                <div class="form-group">
                                    <input type="text" name="program" class="form-control form-control-user"
                                        value="Guru Yatim" readonly>
                                </div>

                                <div class="form-group">
                                    <select class="custom-select form-control-select" name="cabang">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>&copy; Copyright <b>Eprogram Alkirom Amanah 2022.</b> All Rights Reserved</span>
                    </div>
                </div>
            </footer>
        </div>
